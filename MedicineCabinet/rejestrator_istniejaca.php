...
<html>
    ...
    $esql = "INSERT INTO users (imie, email, haslo, apteczki_idapteczki) VALUES ('$user_imie', '$user_email', '$user_password_hash', (SELECT idapteczki FROM apteczki WHERE nazwaApteczki='$user_apteczka'))";
    if (mysqli_fetch_row(mysqli_query($dbconn,$sql_email)) > 0) {
    ...
    } else if (mysqli_query($dbconn, $esql)) {
